...
from homeassistant.components.cover import (ATTR_POSITION, PLATFORM_SCHEMA, CoverState, CoverEntity, CoverDeviceClass)
...
class Hub:
    ...
    def __init__(self, hass: HomeAssistant, host: str, name: str, id: str, mac: str, pos: str) -> None:
        ...
        self.curtains = [
            Curtain(f"{self._id}_1", name, pos, self)
        ]
        self.online = True
...
class Curtain:
    ...
    def __init__(self, id: str, slide_name: str, pos: str, hub: Hub) -> None:
